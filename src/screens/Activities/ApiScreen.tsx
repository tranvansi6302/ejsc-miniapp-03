        ...
        {API_GROUPS.map((group, gIdx) => (
          <Card key={gIdx} className="p-4 rounded-2xl border border-slate-100 shadow-[0_8px_24px_rgba(15,23,42,0.06)] mb-4">
            <div className="flex items-center gap-2 mb-4 border-b border-slate-50 pb-2">
              <div className="text-orange-600">{getGroupIcon(group.name)}</div>
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex flex-col gap-0.5 flex-1 pr-4">
                      <div className="flex items-center gap-2">
                        ...
                        {api.params && (
                          <span className="text-[10px] bg-orange-50 text-orange-600 px-1.5 py-0.5 rounded-full font-bold uppercase">Params</span>
                        )}
                      </div>
                  ...
                  {api.params && (
                    <div className="mt-2 flex flex-col gap-2">
                      ...
                      <textarea
                        className="w-full p-2 bg-slate-50 border border-slate-200 rounded-lg font-mono text-[11px] text-slate-700 focus:outline-none focus:border-orange-300 min-h-[60px]"
