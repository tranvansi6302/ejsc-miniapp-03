...
const AccountScreen: React.FC = () => {
  ...
  return (
    <StandardPage hideAppBar contentClassName="!p-0">
      {/* Header - orange theme cho Mini App 03 */}
      <div className="bg-gradient-to-br from-orange-900 to-orange-700 px-6 pt-24 pb-10 flex flex-col items-center">
      ...
      <div className="px-4 -mt-4 pb-10 flex flex-col gap-4">
        ...
        <Card className="rounded-2xl border border-slate-100 bg-white p-4">
          ...
          <button
            className="w-full flex items-center gap-3 p-3 bg-blue-50 rounded-2xl border border-blue-100 active:scale-[0.98] transition-transform"
            onClick={() => (window as any).ejsc?.openDeeplink({ url: 'ejsc://mini-apps/mini-app-2', title: 'Mini App 02' })}
          >
            <div className="w-9 h-9 rounded-xl bg-blue-600 flex items-center justify-center text-white font-bold text-sm">2</div>
            <Text variant="base" weight="bold" className="flex-1 text-left text-blue-800">Mở Mini App 02</Text>
